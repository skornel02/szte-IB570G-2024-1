...
partial class EditPetForm
{
    ...
    private void InitializeComponent()
    {
        ...
        tableLayoutPanel1.Controls.Add(AgeNumeric, 1, 3);
        tableLayoutPanel1.Controls.Add(WeightNumeric, 1, 4);
        tableLayoutPanel1.Controls.Add(groupBox1, 1, 2);
        tableLayoutPanel1.Controls.Add(CategoryDropdown, 1, 5);
        ...
        tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 11.457757F));
        tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 11.4594269F));
        tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 41.6679153F));
        tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 11.4577589F));
        tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 11.4577589F));
        tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 12.4993744F));
        tableLayoutPanel1.Size = new Size(700, 259);
        ...
        NameTextbox.Location = new Point(213, 3);
        NameTextbox.Margin = new Padding(3, 2, 3, 2);
        NameTextbox.Name = "NameTextbox";
        NameTextbox.Size = new Size(484, 23);
        ...
        CategoryDropdown.Location = new Point(213, 229);
        CategoryDropdown.Margin = new Padding(3, 2, 3, 2);
        CategoryDropdown.Name = "CategoryDropdown";
        CategoryDropdown.Size = new Size(484, 23);
        CategoryDropdown.TabIndex = 9;
        // 
        // AgeNumeric
        // 
        AgeNumeric.Anchor = AnchorStyles.Left | AnchorStyles.Right;
        AgeNumeric.Location = new Point(213, 168);
        AgeNumeric.Margin = new Padding(3, 2, 3, 2);
        AgeNumeric.Maximum = new decimal(new int[] { 25, 0, 0, 0 });
        AgeNumeric.Name = "AgeNumeric";
        AgeNumeric.Size = new Size(484, 23);
        ...
        WeightNumeric.Location = new Point(213, 197);
        WeightNumeric.Margin = new Padding(3, 2, 3, 2);
        WeightNumeric.Name = "WeightNumeric";
        WeightNumeric.Size = new Size(484, 23);
        ...
        groupBox1.Location = new Point(213, 60);
        groupBox1.Margin = new Padding(3, 2, 3, 2);
        groupBox1.Name = "groupBox1";
        groupBox1.Padding = new Padding(3, 2, 3, 2);
        groupBox1.Size = new Size(484, 103);
        ...
        flowLayoutPanel2.Size = new Size(478, 83);
        ...
        GenderMale.Location = new Point(3, 2);
        GenderMale.Margin = new Padding(3, 2, 3, 2);
        GenderMale.Name = "GenderMale";
        GenderMale.Size = new Size(48, 19);
        ...
        GenderFemale.Location = new Point(3, 25);
        GenderFemale.Margin = new Padding(3, 2, 3, 2);
        GenderFemale.Name = "GenderFemale";
        GenderFemale.Size = new Size(69, 19);
        ...
        ClearButton.Location = new Point(9, 8);
        ClearButton.Margin = new Padding(9, 8, 9, 8);
        ClearButton.Name = "ClearButton";
        ClearButton.Size = new Size(215, 36);
        ...
        DefaultValueButton.Location = new Point(242, 8);
        DefaultValueButton.Margin = new Padding(9, 8, 9, 8);
        DefaultValueButton.Name = "DefaultValueButton";
        DefaultValueButton.Size = new Size(215, 36);
        ...
        AddButton.Location = new Point(475, 8);
        AddButton.Margin = new Padding(9, 8, 9, 8);
        AddButton.Name = "AddButton";
        AddButton.Size = new Size(216, 36);
        ...
        TitleLabel.Size = new Size(700, 27);
        ...
        label1.TabIndex = 13;
        label1.Text = "Tulajdonos neve";
        label1.TextAlign = ContentAlignment.MiddleCenter;
        // 
        // OwnerTextBox
        // 
        OwnerTextBox.Anchor = AnchorStyles.Left | AnchorStyles.Right;
        OwnerTextBox.Location = new Point(213, 32);
        OwnerTextBox.Margin = new Padding(3, 2, 3, 2);
        OwnerTextBox.Name = "OwnerTextBox";
        OwnerTextBox.Size = new Size(484, 23);
        OwnerTextBox.TabIndex = 14;
        // 
        // EditPetForm
        // 
