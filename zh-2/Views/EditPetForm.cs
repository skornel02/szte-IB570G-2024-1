...
public partial class EditPetForm : Form
{
    ...
    private void AddPetForm_Load(object sender, EventArgs e)
    {
        ...
        if (_edit != null)
        {
            ...
            OwnerTextBox.Text = _edit.OwnerName;
    ...
    private void DefaultValueButton_Click(object sender, EventArgs e)
    {
        ...
        CategoryDropdown.Text = _controller.Categories.FirstOrDefault() ?? "Kutya";
        OwnerTextBox.Text = "Sanyi";
        AgeNumeric.Value = 5;
    ...
    {
        if (string.IsNullOrWhiteSpace(NameTextbox.Text) || string.IsNullOrWhiteSpace(OwnerTextBox.Text) || string.IsNullOrWhiteSpace(CategoryDropdown.Text))
        {
        ...
        if (_controller.Pets.Any(_ => _.Name == NameTextbox.Text && _edit?.Id != _.Id))
        {
            MessageBox.Show("Név már foglalt!", "Hiba", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        ...
        else
        {
            ...
            _edit.OwnerName = OwnerTextBox.Text;
